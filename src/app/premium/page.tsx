...
const Page =   () => {
    const CHEСKOUT_URL = "https://ai-airer.lemonsqueezy.com/buy/085e3fea-d196-4da3-9be1-2e98c1628505";
    const {user} =  useAuth()

    console.log(user)
    return (
        <div className="min-h-screen bg-[#F0F4FF] flex flex-col items-center py-20 px-4">
            <h1 className="text-4xl md:text-6xl font-bold text-blue-700 mb-12">
                Выберите тариф
            </h1>
            ...
            <div className="flex flex-col md:flex-row gap-8 max-w-6xl w-full justify-center">
                ...
                <div className="bg-blue-700 rounded-3xl shadow-lg p-8 md:p-12 flex-1 text-center text-white hover:shadow-2xl transition relative">
                    ...
                    <div className="text-4xl font-bold mb-6">19.99 RON</div>
                    <ul className="text-left mb-8 space-y-2">
                        <li>✔ ИИ отвечает на 15% быстрее</li>
                        <li>✔ Вам доступны все ИИ функции нашей платформы</li>
                        <li>✔ Приоритетная поддержка</li>
                        <li>✔ Вы помогаете Иван Катковскому копеечкой (нет)</li>
                    </ul>
                    <Button
                disabled={user?.isPrem}
                    ...
                    >
                        ...
                        <a className='flex items-center justify-center gap-2' target='_blank' href={"https://ai-airer.lemonsqueezy.com/buy/085e3fea-d196-4da3-9be1-2e98c1628505"}>
